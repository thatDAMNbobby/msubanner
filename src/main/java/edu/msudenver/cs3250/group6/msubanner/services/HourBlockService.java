...
public class HourBlockService {
     ...
     */
    public HourBlock getHourBlock(final String id) {
        return hourBlockRepository.findById(id);
    }
     ...
     */
    public void addHourBlock(final HourBlock hourBlock) {
        hourBlockRepository.save(hourBlock);
    }
     ...
     */
    public void updateHourBlock(final HourBlock hourBlock) {
        hourBlockRepository.save(hourBlock);
    }
     ...
     */
    public void deleteHourBlock(final String id) {
        hourBlockRepository.delete(id);
    }
