...
/**
 * Data repository interface for Professor class. Using Repository pattern over
 * DAO pattern due to available documentation.
 */
@RepositoryRestResource
@Persistent
public interface ProfessorRepository
extends MongoRepository<Professor, String> {
